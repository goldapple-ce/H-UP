  ...
  const handleDelete = async (e) => {
    ...
    try {
      ...
      const modifiedList = todoList.map((item) => {
        ...
        return { id: item.todoId, content, createdAt, endAt, assigneeList: Todo.assigneeList };
      });
    ...
    <>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className={styles.modalForm}>
          ...
          <div className={styles.modalButtons}>
            <button type="submit" className={styles.submitButton}>Modify</button>
      ...
      >
        ...
        <form className={styles.modalForm}>
          ...
          <div className={styles.modalButtons}>
            <button type="button" onClick={closeManageModal} className={styles.cancelButton}>Close</button>
          </div>
        </form>
      </Modal>
    </>
